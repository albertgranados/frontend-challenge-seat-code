    ...
    <div className="py-4 sm:p-4 min-w-full inline-block">
      <div
        className={classNames(
          !isLoading && !error && 'ring-1 ring-gray-300',
          'sm:mx-0 sm:rounded-lg overflow-hidden min-w-full overflow-y-auto max-h-[600px]'
        )}
      >
        {isLoading ? (
          <div className="h-[600px] animate-pulse bg-gray-100" />
        ) : error ? (
          <div className="flex h-[600px] bg-gray-100 items-center justify-center">
